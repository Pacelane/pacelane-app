...
CREATE INDEX idx_knowledge_files_gcs_path ON public.knowledge_files(gcs_path);
CREATE INDEX idx_knowledge_files_content_extracted ON public.knowledge_files(content_extracted);
